...
public class Ocean : MonoBehaviour 
{
	...
	public ComputeShader m_writeData, m_readData;
	...
	public float SampleHeight(Vector3 worldPos) { return m_waves.SampleHeight(worldPos) + m_seaLevel; }
